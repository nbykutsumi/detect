...
# Monsoon
#**********************************
python ./ms.mkRegion.py                 # Make a mask for monson region
python ./ms.FindMinMax.py               # Make annual min and max moisture content
python ./ms.mkMonsoon.py                # Make monsoon daily map
